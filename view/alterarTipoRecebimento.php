...
<body>
	...
	<form method="post" action="../controller/alterarTipoRecebimentoSalvar.php"> 	
		<div class="divPrincipalEdicao">
			...
			<div> 
				...
				<input id="txtDescricao" name="txtDescricao" required="required" value="<?=utf8_encode( $tr->txtDescricao )?>" type="text" placeholder="Descrição" />
